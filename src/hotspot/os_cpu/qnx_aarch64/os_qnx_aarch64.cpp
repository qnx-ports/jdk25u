...
#define context_x    uc_mcontext.cpu.gpr
#define context_fp   context_x[29]
#define context_lr   context_x[AARCH64_REG_LR]
#define context_sp   context_x[AARCH64_REG_SP]
#define context_pc   uc_mcontext.cpu.elr
