...
#ifndef OS_QNX_OSTHREAD_QNX_HPP
#define OS_QNX_OSTHREAD_QNX_HPP
...
class OSThread : public OSThreadBase {
 ...
 public:
  ...
  // flags that support signal based suspend/resume on Qnx are in a
