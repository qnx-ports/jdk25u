...
/*
 * Class:     jdk_net_QnxSocketOptions
 * Method:    keepAliveOptionsSupported0
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_jdk_net_QnxSocketOptions_keepAliveOptionsSupported0
 ...
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_jdk_net_QnxSocketOptions_setTcpKeepAliveProbes0
 ...
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_jdk_net_QnxSocketOptions_setTcpKeepAliveTime0
(JNIEnv *env, jobject unused, jint fd, jint optval) {
 ...
 * Signature: (I)L
 */
JNIEXPORT jlong JNICALL Java_jdk_net_QnxSocketOptions_getSoPeerCred0
 ...
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_jdk_net_QnxSocketOptions_setTcpKeepAliveIntvl0
(JNIEnv *env, jobject unused, jint fd, jint optval) {
 ...
 * Signature: (I)I;
 */
JNIEXPORT jint JNICALL Java_jdk_net_QnxSocketOptions_getTcpKeepAliveProbes0
 ...
 * Signature: (I)I;
 */
JNIEXPORT jint JNICALL Java_jdk_net_QnxSocketOptions_getTcpKeepAliveTime0
(JNIEnv *env, jobject unused, jint fd) {
    jint optval, rv;
    socklen_t sz = sizeof (optval);
 ...
 * Signature: (I)I;
 */
JNIEXPORT jint JNICALL Java_jdk_net_QnxSocketOptions_getTcpKeepAliveIntvl0
(JNIEnv *env, jobject unused, jint fd) {
    jint optval, rv;
    socklen_t sz = sizeof (optval);
